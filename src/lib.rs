...
pub use writer::{
    ansi_enabled, interactive_tty, is_tty, pipe_aware, term_height, term_width, visual_rows, write, write_err,
    writeln,
};
...
pub use statusbar::{statusbar, statusbar_render, statusbar_render_wrapped, Segment, StatusBarConfig};
pub use stream::{stream, stream_with, Stream, StreamOptions};

// ── Display Component re-exports ─────────────────────────────────────

pub use banner::{banner, BannerColorFn, BannerOptions, BannerStyle};
pub use braille::{ascii_to_braille, ascii_to_braille_with, grid_to_braille};
pub use columns::{columns, ColumnsOptions};
pub use diff::{diff, DiffOptions};
pub use flex::{flex, FlexAlign, FlexBlock, FlexOptions};
...
pub use heatmap::{heatmap, Colormap, HeatmapOptions};
...
pub use number::{format_bytes, format_compact, format_number, format_rate};
pub use progress::{progress, ProgressBar, ProgressOptions};
pub use progress_bar::{render_progress_bar, BarStyle, RenderOptions};
pub use spinner::{all_spinner_names, get_spinner, spinner, Spinner, SpinnerDef, SpinnerOptions};
pub use timer::{
